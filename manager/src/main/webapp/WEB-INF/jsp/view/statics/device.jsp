...
<div id="container" class="container">
    <div class="wrap-contents">
        <div class="page-control">
            <div class="row">
                <div class="col-xs-12">
                    <span class="page-title"> 접속 디바이스</span>
                </div>
            </div>
        </div>
        <div class="contents">
                       ...
                       <c:forEach var="device" items="${list}" varStatus="status">
                           <c:if test="${!status.last}">
                               <tr>
                                   ...
                                   <td><fmt:formatNumber value="${device.tot}" pattern="#,###"/></td>
                                   <td>${device.per} %</td>
                               </tr>
                           </c:if>
                       </c:forEach>
...
<script type="text/javascript">
    ...
    function dateService(){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/statics/device",
            type: "POST",
    ...
    function monthService(){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/statics/monthAccessDevice",
            type: "POST",
    ...
    function yearService(){
      ...
      $.ajax({
            url: "${pageContext.request.contextPath}/statics/yearAccessDevice",
            type: "POST",
