...
<script src="${vwaFrontUrl}/resources/scripts/jquery/plugins/jquery.utils.js"></script>
<script src="${vwaFrontUrl}/resources/scripts/jquery/plugins/jquery.layer.js"></script>
<script src="${vwaFrontUrl}/resources/scripts/jquery/plugins/jquery.slick.js"></script>
    ...
    <section class="section section-detail">
        <div class="inner">
            <div class="header">
                ...
                <div class="utils">
                    <button type="button" class="icon icon-util-line-like"></button>
                    <button type="button" class="icon icon-util-share"></button>
                ...
                <button type="button" class="icon icon-sub-page-close"></button>
            </div>
            <div class="calculator-wrap">
                ...
                <div class="calculator">
                    ...
                    <div class="body">
                        ...
                        <p class="buttons">
                            <button type="button" class="btn btn-primary btn-radius"><em>문의하기</em></button>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <article id="detail-table" class="table">
                ...
                <div class="check-point">
                    <div class="item panel">
                        ...
                        <img src="${vwaFrontUrl}/resources/images/car-check-front.png" alt="외판 부위의 교환, 부식, 판금 및 용접수리">
                    </div>
                    <div class="item frame">
                        ...
                        <img src="${vwaFrontUrl}/resources/images/car-check-back.png" alt="주요골격 부위의 교환, 부식, 판금 및 용접수리">
                    </div>
                </div>
                <div class="guide">
                    <ul>
            ...
            <div class="layer-body">
                ...
                <div class="table table-center table-responsive-status">
                    ...
                    <span class="mobile-car" data-title="외판 부위의 교환,부식,판금 및 용접수리">
                        <i><img src="${vwaFrontUrl}/resources/images/car_expansion_plan_front.gif" alt=""></i>
                    </span>
                    <table>
                        <colgroup>
                            <col style="width: 50%;">
                ...
                <div class="table table-center table-responsive-status">
                    <span class="mobile-car" data-title="주요골격 부위의 교환, 부식, 판금 및 용접수리">
                        <i><img src="${vwaFrontUrl}/resources/images/car_expansion_plan_back.gif" alt=""></i>
                    </span>
                    <table>
                        <colgroup>
                            <col style="width: 50%">
